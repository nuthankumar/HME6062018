...
export default class MasqueradeHeader extends React.Component {
    ...
    render() {
        ...
        return (
                <span className="view-as"><button type="button"> <a href={url + "?pg=SettingsUsers&path=Main&token=" + masquerade} onClick={this.authService.logoutMasquerade.bind()}> X </a></button> Currently Viewing As {viewAsUser.User_EmailAddress} </span>
        )
    }
}
