...
-- ===========================================================
-- Name			:	usp_HME_Cloud_Get_Report_By_Date
-- Author		:	Swathi Kumar
...
-- 1.
-- ===========================================================
-- EXEC [dbo].[usp_HME_Cloud_Get_Report_By_Date] '4', '2018-03-24', '2018-03-24'
-- ===========================================================

CREATE PROCEDURE [dbo].[usp_HME_Cloud_Get_Report_By_Date](
...
BEGIN
	/*
		...
		Description:
			This proc is used for Cloud Reporting of day report.
		...
		Usage:
			EXECUTE dbo.usp_HME_Cloud_Get_Report_By_Date @Device_IDs, @StoreStartDate, @StoreEndDate, @StartDateTime, @EndDateTime, @CarDataRecordType_ID, @ReportType, @LaneConfig_ID
	...
	*************************************/
	...
	SET @query = N'
		...
		FROM	#raw_data d INNER JOIN #GroupDetails ts ON d.Store_ID = ts.Store_ID
	...
	IF (@PageNumber >0 )
	BEGIN
		INSERT INTO #rollup_data(ID, StoreNo, Device_UID, StoreDate, Device_ID, GroupName, Store_ID, Category, AVG_DetectorTime , Total_Car)
		SELECT ID, StoreNo, Device_UID, StoreDate, Device_ID, GroupName, Store_ID, Category, AVG_DetectorTime , Total_Car 
	...
	***********************************/
	...
	-- exec usp_HME_Cloud_Get_Report_By_Date '1370,1385', '2014-07-01', '2014-07-06', null, null, '11'--, 'TC' '2014-08-11 09:00:00', '2014-08-17 11:30:00', '11'--, 'TC'
	-- exec usp_HME_Cloud_Get_Report_By_Date '2955', '2015-01-27', '2015-01-28', null, null, '11'--, 'TC' '2014-08-11 09:00:00', '2014-08-17 11:30:00', '11'--, 'TC'
	-- exec usp_HME_Cloud_Get_Report_By_Date '1385', '2014-07-01', '2014-07-01', null, null, '11'--, 'TC' '2014-08-11 09:00:00', '2014-08-17 11:30:00', '11'--, 'TC'
	-- exec usp_HME_Cloud_Get_Report_By_Date '1382,1354', '2014-08-22', '2014-08-25', null, null, '11'--, 'TC'
	-- exec usp_HME_Cloud_Get_Report_By_Date '1379,2987', '2014-08-11', '2014-08-11', null, null, '11'--, 'TC'

	-- exec [usp_HME_Cloud_Get_Report_By_Date] '15', '2018-03-24', '2018-03-24', '2018-03-24 00:00:00' , '2018-03-24 12:00:00', 11, 'AC'
