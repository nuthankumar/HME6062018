...
GO
/****** Dropping the StoredProcedure [dbo].[usp_GetUnregisteredSystems] if already exists *****/
IF (EXISTS(SELECT * FROM sys.objects WHERE [name] = 'usp_GetUnregisteredSystems' AND [type] ='P'))
	DROP PROCEDURE [dbo].usp_GetUnregisteredSystems
GO
...
-- ===========================================================
-- Name			:	usp_GetUnregisteredSystems
-- Author		:	Jayaram
-- Created		:	17-MAY-2018
...
--
-- ===========================================================
-- EXEC [dbo].[usp_GetUnregisteredSystems] @PageNumber=1, @criteria='2.00',@filter=Device_MainVersion , @RecordPerPage=20

-- sorting
-- EXEC [dbo].[usp_GetUnregisteredSystems] @PageNumber=1,@SortingColumnName=Device_MainVersion,@SortingType='DESC'
-- ===========================================================

CREATE PROCEDURE [dbo].[usp_GetUnregisteredSystems]
(
