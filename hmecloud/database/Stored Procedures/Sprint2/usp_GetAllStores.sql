...
/****** Dropping the StoredProcedure [dbo].[usp_GetAllStores] if already exists *****/
IF (EXISTS(SELECT * FROM sys.objects WHERE [name] = 'usp_GetAllStores' AND [type] ='P'))
	DROP PROCEDURE [dbo].[usp_GetAllStores]
GO

-- ===========================================================
--      Copyright © 2018, HME, All Rights Reserved
-- ===========================================================
-- Name			:	usp_GetAllStores
...
--	2.
-- ===========================================================
-- exec [dbo].[usp_GetAllStores] @UserUid='68LKBP85C1SKH1FI3M7X40CJHKGU07FZ',@isAdmin=0,@criteria=NULL,@filter=NULL,@SortingColumnName=NULL,@SortingType=NULL,@RecordPerPage=25,@PageNumber=0
-- ===========================================================
