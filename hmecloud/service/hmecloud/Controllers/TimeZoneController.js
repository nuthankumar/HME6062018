...
const repository = require('../Repository/TimeZoneRepository')
const validator = require('../Validators/TimeZoneValidator')
...
/**
 * The method can be used to execute getAll TimeZone
